function updatePopupContent(button, popup, production_par_click, production_par_seconde, nb_bonus_click_achete, nb_autoclick_achete, x_bonus_click_produit, x_autoclick_produit, total_cookies_autoclicker) {
    popup.innerHTML = button.classList.contains('bonus-click-button')
        ...
        ${nb_autoclick_achete} autoclickers produisant ${x_autoclick_produit} score.<br>
...
function createHoverPopup(buttonElement, popupElement, etage) {
    buttonElement.addEventListener('mouseenter', function() {
        updatePopupContent(buttonElement, popupElement, etage.production_par_click, etage.production_par_seconde, etage.nb_bonus_click_achete, etage.nb_autoclick_achete, etage.x_bonus_click_produit, etage.x_autoclick_produit, etage.total_cookies_autoclicker);
